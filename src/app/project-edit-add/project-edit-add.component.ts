...
import {
  appSumoHighlightedFeaturesPlanATier1,
  appSumoHighlightedFeaturesPlanATier2,
  appSumoHighlightedFeaturesPlanATier3,
  appSumoHighlightedFeaturesPlanATier4,
  APPSUMO_PLAN_SEATS,
  APP_SUMO_PLAN_NAME,
  avatarPlaceholder,
  featuresPlanA,
  ...
  PLAN_NAME,
  PLAN_SEATS,
  URL_setting_up_automatic_assignment,
} from "./../utils/util";
...
export class ProjectEditAddComponent implements OnInit, OnDestroy {
...

  {
    ...
    this.tParamsFreePlanSeatsNum = {
      free_plan_allowed_seats_num: PLAN_SEATS.free,
    };
  ...
  getBrowserVersion() {
    this.auth.isChromeVerGreaterThan100.subscribe(
      (isChromeVerGreaterThan100: boolean) => {
  ...
  onValueChanged(data?: any) {
    ...
    this.logger.log(
      "onValueChanged expirationDate status",
      expirationDate.status
    );

    if (expirationDate.value && expirationDate.value.length === 7) {
      this.logger.log(
        "onValueChanged expirationDate status expirationDate.value.length",
        expirationDate.value.length
      );
      if (expirationDate.status === "INVALID") {
        ...
        this.logger.log(
          "onValueChanged expirationDate INVALID credit_card_error_msg",
          this.credit_card_error_msg
        );
      }
  ...
  listenSidebarIsOpened() {
    this.auth.settingSidebarIsOpned.subscribe((isopened) => {
      this.logger.log(
        "[PRJCT-EDIT-ADD] SETTINGS-SIDEBAR isopened (FROM SUBSCRIPTION) ",
        isopened
      );
    ...
    this.auth.project_bs
      ...
      .subscribe((project) => {
        if (project) {
          ...
          this.logger.log(
            "[PRJCT-EDIT-ADD] GET CURRENT PROJECT projectId ",
            this.projectId
          );
          this.projectName = project.name;
          this.logger.log(
            "[PRJCT-EDIT-ADD] GET CURRENT PROJECT projectName ",
            this.projectName
          );
        }
      });
  ...
  translateStrings() {
    ...
    this.translate.get("Pricing.UpgradePlan").subscribe((translation: any) => {
      this.upgradePlan = translation;
    });

    this.translate.get("Cancel").subscribe((translation: any) => {
      this.cancel = translation;
    });

    this.translate
      .get("FeatureAvailableOnlyWithPaidPlans")
      .subscribe((translation: any) => {
        this.featureAvailableOnlyWithPaidPlans = translation;
      });

    this.translate
      .get("OnlyUsersWithTheOwnerRoleCanManageSMTPsettings")
      .subscribe((translation: any) => {
        this.onlyUsersWithTheOwnerRoleCanManageSMTPsettings = translation;
      });

    this.translate
      .get("OnlyUserWithOwnerRoleCanManageAdvancedProjectSettings")
      .subscribe((translation: any) => {
        this.onlyUserWithOwnerRoleCanManageAdvancedProjectSettings =
          translation;
      });
  }
  ...
  translateThereHasBeenAnErrorProcessing() {
    this.translate
      .get("ThereHasBeenAnErrorProcessing")
      .subscribe((translation: any) => {
  ...
  translateNotificationMsgs() {
    this.translate
      .get("ProjectEditPage.NotificationMsgs")
      .subscribe((translation: any) => {
  ...
  translateOnlyATeammateWithTheOwnerRoleCanDeleteAProject() {
    this.translate
      .get("OnlyATeammateWithTheOwnerRoleCanDeleteAProject")
      .subscribe((translation: any) => {
  ...
  translateModalOnlyOwnerCanManageProjectAccount() {
    ...
    this.translate
      .get("OnlyUsersWithTheOwnerRoleCanManageTheEmailTemplate")
      .subscribe((translation: any) => {
        // this.logger.log('[PRJCT-EDIT-ADD] onlyOwnerCanManageTheAccountPlanMsg text', translation)
    ...
    this.translate
      .get("ProjectEditPage.FeatureOnlyAvailableWithTheEnterprisePlan")
      .subscribe((translation: any) => {
        // this.logger.log('[PRJCT-EDIT-ADD] onlyOwnerCanManageTheAccountPlanMsg text', translation)
  ...
  getPendingInvitation() {
    this.usersService.getPendingUsers().subscribe(
      (pendingInvitation: any) => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] - GET PENDING INVITATION ",
          pendingInvitation
        );
        ...
        if (pendingInvitation) {
          ...
          this.logger.log(
            "[PRJCT-EDIT-ADD] - # OF PENDING INVITATION ",
      ...
      (error) => {
        this.logger.error(
          "[PRJCT-EDIT-ADD] - GET PENDING INVITATION - ERROR",
          error
        );
      },
      () => {
  ...
  getAllUsersOfCurrentProject() {
    this.usersService.getProjectUsersByProjectId().subscribe(
      (projectUsers: any) => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] GET PROJECT USERS - RES ",
          projectUsers
        );
        ...
        if (projectUsers) {
          ...
          this.logger.log(
            "[PRJCT-EDIT-ADD] # OF PROJECT USERS ",
  ...
  getCurrentUrlAndSwitchView() {
    ...
    this.logger.log(
      "[PRJCT-EDIT-ADD] - PROJECT_SETTINGS_ROUTE ",
      currentUrl.indexOf("/project-settings/general")
    );
    this.logger.log(
      "[PRJCT-EDIT-ADD] - PROJECT_SETTINGS_PAYMENTS_ROUTE ",
      currentUrl.indexOf("/project-settings/payments")
    );
    this.logger.log(
      "[PRJCT-EDIT-ADD] - PROJECT_SETTINGS_AUTH_ROUTE ",
      currentUrl.indexOf("/project-settings/auth")
    );
    this.logger.log(
      "[PRJCT-EDIT-ADD] - PROJECT_SETTINGS_AUTH_ROUTE ",
      currentUrl.indexOf("/project-settings/advanced")
    );
    this.logger.log(
      "[PRJCT-EDIT-ADD] - PROJECT_SETTINGS_NOTIFICATION ",
      currentUrl.indexOf("/project-settings/notification")
    );
    ...
    if (
      ...
      this.logger.log(
        "[PRJCT-EDIT-ADD] - is PROJECT_SETTINGS_ROUTE ",
        this.PROJECT_SETTINGS_ROUTE
      );
      this.logger.log(
        "[PRJCT-EDIT-ADD] - is PROJECT_SETTINGS_PAYMENTS_ROUTE ",
        this.PROJECT_SETTINGS_PAYMENTS_ROUTE
      );
      this.logger.log(
        "[PRJCT-EDIT-ADD] - is PROJECT_SETTINGS_AUTH_ROUTE ",
        this.PROJECT_SETTINGS_AUTH_ROUTE
      );
      this.logger.log(
        "[PRJCT-EDIT-ADD] - is PROJECT_SETTINGS_ADVANCED_ROUTE ",
        this.PROJECT_SETTINGS_ADVANCED_ROUTE
      );
      this.logger.log(
        "[PRJCT-EDIT-ADD] - is PROJECT_SETTINGS_NOTIFICATION ",
        this.PROJECT_SETTINGS_NOTIFICATION_ROUTE
      );
      this.logger.log(
        "[PRJCT-EDIT-ADD] - is PROJECT_SETTINGS_SECURITY_ROUTE ",
        this.PROJECT_SETTINGS_SECURITY_ROUTE
      );
  ...
  goToProjectSettings_Payments() {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - HAS CLICKED goToProjectSettings_Payments USER_ROLE ",
      this.USER_ROLE
    );
    if (this.USER_ROLE === "owner") {
      this.logger.log(
        "[PRJCT-EDIT-ADD] - HAS CLICKED goToProjectSettings_Payments "
      );
      this.router.navigate([
        "project/" + this.id_project + "/project-settings/payments",
      ]);
      if (!isDevMode()) {
        if (window["analytics"]) {
          try {
    ...
    swal({
      ...
      if (value === "catch") {
        ...
        if (this.isVisiblePaymentTab) {
          if (this.USER_ROLE === "owner") {
            if (
              this.prjct_profile_type === "payment" &&
  ...
  presentModalOnlyOwnerCanManageEmailTempalte() {
    ...
    this.notify.presentModalOnlyOwnerCanManageTheAccountPlan(
      this.onlyOwnerCanManageEmailTempalte,
  ...
  goToProjectSettings_General() {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - HAS CLICKED goToProjectSettings_General "
    );
    this.router.navigate([
      "project/" + this.id_project + "/project-settings/general",
    ]);
  }
  ...
  goToProjectSettings_Auth() {
    ...
    this.router.navigate([
      "project/" + this.id_project + "/project-settings/auth",
    ]);
  }

  goToProjectSettings_Advanced() {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - HAS CLICKED goToProjectSettings_Advanced"
    );
    if (this.USER_ROLE === "owner") {
      this.router.navigate([
        "project/" + this.id_project + "/project-settings/advanced",
      ]);
    } else {
  ...
  goToProjectSettings_Notification() {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - HAS CLICKED goToProjectSettings_Notification"
    );
    this.router.navigate([
      "project/" + this.id_project + "/project-settings/notification",
    ]);
  }
    ...
    if (this.USER_ROLE === "owner") {
      if (
        ...
        if (this.subscription_is_active === true) {
          ...
          this.router.navigate([
            "project/" + this.id_project + "/project-settings/security",
          ]);
  ...
  presentModalAgentCannotManageAvancedSettings() {
    this.notify.presentModalOnlyOwnerCanManageTheAccountPlan(
      this.onlyOwnerCanManageAdvancedProjectSettings,
      this.learnMoreAboutDefaultRoles
    );
  }
    ...
    if (this.USER_ROLE === "owner") {
      if (
        ...
        if (this.subscription_is_active === true) {
          ...
          this.router.navigate([
            "project/" + this.id_project + "/project-settings/banned",
          ]);
        } else if (this.subscription_is_active === false) {
  ...
  goToCustomizeNotificationEmailPage() {
    ...
    this.logger.log(
      "goToCustomizeNotificationEmailPage profile_name ",
      this.profile_name
    );
    ...
    if (this.USER_ROLE === "owner") {
      if (
        ...
        if (this.subscription_is_active === true) {
          ...
          this.router.navigate([
            "project/" + this.id_project + "/notification-email",
          ]);
        } else if (this.subscription_is_active === false) {
    ...
    if (this.USER_ROLE === "owner") {
      if (
        ...
        if (this.subscription_is_active === true) {
          ...
          this.router.navigate([
            "project/" + this.id_project + "/smtp-settings",
          ]);
        } else if (this.subscription_is_active === false) {
  ...
  presentModalOnlyOwnerCanManageTSMTPsettings() {
    this.notify.presentModalOnlyOwnerCanManageTheAccountPlan(
      this.onlyUsersWithTheOwnerRoleCanManageSMTPsettings,
      this.learnMoreAboutDefaultRoles
    );
  }
  ...
  translateMsgSubscriptionCanceledSuccessfully() {
    this.translate
      .get("SubscriptionSuccessfullyCanceled")
  ...
  translateMsgSubscriptionCanceledError() {
    this.translate
      .get("AnErrorOccurredWhileCancellingSubscription")
      .subscribe((text: string) => {
  ...
  translateAvailableWithPlusOrCustomPlan(planName) {
    ...
    //   }
    this.translate
      .get("AvailableWithThePlan", { plan_name: planName })
      .subscribe((translation: any) => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] AvailableWithThePlan translation ",
          translation
        );
        this.cPlanOnly = translation;
      });
  ...
  SMTPsettingsValue() {
    this.public_Key =
      this.appConfigService.getConfig().t2y12PruGU9wUtEGzBJfolMIgK;
  ...
  manageSmtpSettingsVisibility(projectProfileData) {
    ...
    if (projectProfileData["customization"]) {
      this.logger.log(
        "[PRJCT-EDIT-ADD] USECASE EXIST customization > SMTPsettings (1)",
        projectProfileData["customization"]["smtpSettings"]
      );
    }

    if (
      projectProfileData["customization"] &&
      projectProfileData["customization"]["smtpSettings"] !== undefined
    ) {
      this.logger.log(
        "[PRJCT-EDIT-ADD] USECASE A EXIST customization ",
        projectProfileData["customization"],
        " & smtpSettings",
        projectProfileData["customization"]["smtpSettings"]
      );
      ...
      if (projectProfileData["customization"]["smtpSettings"] === true) {
        ...
        this.logger.log(
          "[PRJCT-EDIT-ADD] SMTP Settings USECASE A isVisibleSMTPsettings",
          this.isVisibleSMTPsettings
        );
      } else if (
        projectProfileData["customization"]["smtpSettings"] === false
      ) {
      ...
      this.logger.log(
        "PRJCT-EDIT-ADD] USECASE B EXIST customization ",
        projectProfileData["customization"],
        " BUT smtpSettings IS",
        projectProfileData["customization"]["smtpSettings"]
      );
      ...
      if (this.public_Key.includes("MTS")) {
        this.logger.log(
          "[PRJCT-EDIT-ADD] SMTP Settings  USECASE B  (from FT) - EXIST MTS ",
          this.public_Key.includes("MTS")
        );

        this.isVisibleSMTPsettings = this.SMTPsettingsValue();
        this.logger.log(
          "[PRJCT-EDIT-ADD]  this.isVisibleSMTPsettings from FT ",
          this.isVisibleSMTPsettings
        );
        ...
        this.isVisibleSMTPsettings = false;
        this.logger.log(
          "[PRJCT-EDIT-ADD] SMTP Settings  USECASE B (from FT) isVisibleSMTPsettings",
          this.isVisibleSMTPsettings
        );
      }
    } else if (projectProfileData["customization"] === undefined) {
      this.logger.log(
        "[PRJCT-EDIT-ADD] USECASE C customization is  ",
        projectProfileData["customization"],
        "get value foem FT"
      );
      if (this.public_Key.includes("MTS")) {
        ...
        this.isVisibleSMTPsettings = false;
        this.logger.log(
          "[WPRJCT-EDIT-ADD] WSMTP Settings  USECASE B (from FT) isVisibleWidgetUnbranding",
          this.isVisibleSMTPsettings
        );
      }
    }
  ...
  getProjectPlan() {
    this.subscription = this.prjctPlanService.projectPlan$.subscribe(
      (projectProfileData: any) => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] - getProjectPlan project Profile Data",
          projectProfileData
        );
        if (projectProfileData) {
          this.prjct_name = projectProfileData.name;
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan prjct_name",
            this.prjct_name
          );

          this.profile_name = projectProfileData.profile_name;
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan profile_name",
            this.profile_name
          );

          this.prjct_trial_expired = projectProfileData.trial_expired;
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan prjct_trial_expired",
            this.prjct_trial_expired
          );

          this.prjc_trial_days_left = projectProfileData.trial_days_left;
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan prjc_trial_days_left",
            this.prjc_trial_days_left
          );

          this.subscription_is_active =
            projectProfileData.subscription_is_active;
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan subscription_is_active",
            this.subscription_is_active
          );

          this.subscription_end_date = projectProfileData.subscription_end_date;
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan subscription_end_date",
            this.subscription_end_date
          );

          this.subscription_start_date =
            projectProfileData.subscription_start_date;
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan subscription_start_date",
            this.subscription_start_date
          );

          this.prjct_profile_type = projectProfileData.profile_type;
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan prjct_profile_type",
            this.prjct_profile_type
          );
          ...
          if (projectProfileData.subscription_creation_date) {
            this.subscription_creation_date =
              projectProfileData.subscription_creation_date;
          }
          // else {
          //   this.subscription_creation_date = projectProfileData.subscription_start_date;
          // }
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan subscription_creation_date",
            this.subscription_creation_date
          );
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan subscription_creation_date typeof",
            typeof this.subscription_creation_date
          );

          if (projectProfileData.subscription_id) {
            this.subscription_id = projectProfileData.subscription_id;
            this.logger.log(
              "[PRJCT-EDIT-ADD] - subscription_id ",
              this.subscription_id
            );
            if (this.subscription_id.startsWith("sub_")) {
              this.isSripeSub = true;
              this.logger.log(
                "[PRJCT-EDIT-ADD] - is a stripe subscription ",
                this.isSripeSub
              );
            } else {
              this.isSripeSub = false;
              this.logger.log(
                "[PRJCT-EDIT-ADD] - NOT is a stripe subscription ",
                this.isSripeSub
              );
            }
          } else {
          ...
          if (projectProfileData.extra3) {
            ...
            this.logger.log(
              "[PRJCT-EDIT-ADD] - GET PROJECT PLAN  appSumoProfile ",
              this.appSumoProfile
            );
          }
          ...
          if (projectProfileData.extra4) {
            ...
            this.logger.log(
              "[PRJCT-EDIT-ADD] - GET PROJECT PLAN  appSumoInvoiceUUID ",
              this.appSumoInvoiceUUID
            );
          }
          ...
          if (projectProfileData.profile_type === "free") {
            if (projectProfileData.trial_expired === false) {
              if (this.profile_name === "free") {
                ...
                this.tParamsPlanAndSeats = {
                  plan_name: this.prjct_profile_name,
                  allowed_seats_num: this.seatsLimit,
                };
                this.tParamsFeatureAvailableWith = { plan_name: PLAN_NAME.F };
                this.translateAvailableWithPlusOrCustomPlan(PLAN_NAME.F);
            ...
            if (this.subscription_is_active === true) {
              if (projectProfileData.profile_name === PLAN_NAME.A) {
                if (!this.appSumoProfile) {
                  ...
                  this.tParamsPlanAndSeats = {
                    plan_name: PLAN_NAME.A,
                    allowed_seats_num: this.seatsLimit,
                  };
                  this.logger.log(
                    "[PRJCT-EDIT-ADD] - GET PROJECT PLAN - PLAN_NAME ",
                    PLAN_NAME.A,
                    " SEATS LIMIT: ",
                    this.seatsLimit
                  );
                  ...
                  this.prjct_profile_name =
                    PLAN_NAME.A + " plan " + "(" + this.appSumoProfile + ")";
                  this.seatsLimit =
                    APPSUMO_PLAN_SEATS[projectProfileData.extra3];
                  this.tParamsPlanAndSeats = {
                    plan_name: this.prjct_profile_name,
                    allowed_seats_num: this.seatsLimit,
                  };
                ...
                if (!this.appSumoProfile) {
                  ...
                  this.prjct_profile_name =
                    PLAN_NAME.B + " plan " + "(" + this.appSumoProfile + ")";
                  this.seatsLimit =
                    APPSUMO_PLAN_SEATS[projectProfileData.extra3];
                  this.tParamsPlanAndSeats = {
                    plan_name: this.prjct_profile_name,
          ...
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan project Profile Data current_sub_end_date ",
            current_sub_end_date
          );

          this.days_to_next_renew = current_sub_end_date.diff(today, "days");
          this.logger.log(
            "[PRJCT-EDIT-ADD] - getProjectPlan project Profile Data days_to_next_renew ",
            this.days_to_next_renew
          );

          if (this.days_to_next_renew === 0) {
            this.timeOfNextRenew = moment(current_sub_end_date).format("HH.mm");
            this.logger.log(
              "[PRJCT-EDIT-ADD] - getProjectPlan project Profile Data timeOfNextRenew ",
              this.timeOfNextRenew
            );
          }
          ...
          if (
            this.days_to_next_renew === -1 ||
            this.days_to_next_renew === -2
          ) {
            this.SUBSCRIPTION_BUFFER_DAYS = true;
            this.logger.log(
              "[PRJCT-EDIT-ADD] - getProjectPlan days_to_next_renew ",
              this.days_to_next_renew,
              " SUBSCRIPTION_BUFFER_DAYS ",
              this.SUBSCRIPTION_BUFFER_DAYS
            );
          } else {
          ...
          // ------------------------------------------------------------------------------------------------------------------------------------------------
          this.logger.log(
            "[PRJCT-EDIT-ADD] this.subscription_id ",
            this.subscription_id,
            " before to run getSubscriptionPayments & getCustomerAndPaymentMethods"
          );
  ...
  getOSCODE() {
    this.public_Key =
      this.appConfigService.getConfig().t2y12PruGU9wUtEGzBJfolMIgK;
    this.logger.log(
      "[PRJCT-EDIT-ADD] getAppConfig public_Key",
      this.public_Key
    );
  ...
  getSubscriptionPayments(subscription_id) {
    this.projectService.getSubscriptionPayments(subscription_id).subscribe(
      (subscriptionPayments: any) => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] GET subscriptionPayments ",
          subscriptionPayments
        );

        this.subscriptionPaymentsLength = subscriptionPayments.length;
        this.logger.log(
          "[PRJCT-EDIT-ADD] GET subscriptionPayments Length ",
          this.subscriptionPaymentsLength
        );
        if (subscriptionPayments) {
          this.subscription_payments = [];
          subscriptionPayments.forEach((subscriptionPayment, index) => {
            this.logger.log(
              "[PRJCT-EDIT-ADD] subscriptionPayment.stripe_event ",
              subscriptionPayment.stripe_event
            );

            if (
              subscriptionPayment.stripe_event === "checkout.session.completed"
            ) {
              this.subscription_creation_date =
                subscriptionPayment.object.start_date;
              this.logger.log(
                "[PRJCT-EDIT-ADD] -  subscriptionPayments (checkout.session.completed) > subscription creation date ",
                this.subscription_creation_date
              );
            }

            if (
              subscriptionPayment.stripe_event === "invoice.payment_succeeded"
            ) {
              /**
               ...
               */
              if (
                subscriptionPayment.object.data.object.billing_reason ===
                "subscription_create"
              ) {
                this.subscription_creation_date =
                  subscriptionPayment.object.data.object.lines.data[0].period.start;
                this.logger.log(
                  "[PRJCT-EDIT-ADD] -  subscriptionPayments (invoice.payment_succeeded subscription_create) > subscription creation date ",
                  this.subscription_creation_date
                );
              }
              ...
              this.plan_amount =
                subscriptionPayment.object.data.object.lines.data[0].plan.amount;
              this.logger.log(
                "[PRJCT-EDIT-ADD] - subscriptionPayments plan_amount ",
                this.plan_amount
              );

              this.plan_interval =
                subscriptionPayment.object.data.object.lines.data[0].plan.interval;
              this.logger.log(
                "[PRJCT-EDIT-ADD] - subscriptionPayments plan_interval ",
                this.plan_interval
              );

              const plan_description =
                subscriptionPayment.object.data.object.lines.data[0]
                  .description;
              this.logger.log(
                "[PRJCT-EDIT-ADD] subscriptionPayment plan_description: ",
                plan_description
              );
              if (plan_description.indexOf("×") !== -1) {
                const planSubstring = plan_description.split("×").pop();
                this.logger.log(
                  "[PRJCT-EDIT-ADD] subscriptionPayment planSubstring: ",
                  planSubstring
                );
                if (plan_description.indexOf("(") !== -1) {
                  const planName = planSubstring.substring(
                    0,
                    planSubstring.indexOf("(")
                  );
                  this.logger.log(
                    "[PRJCT-EDIT-ADD] subscriptionPayment planName: ",
                    planName
                  );
          ...
          this.logger.log(
            "[PRJCT-EDIT-ADD] FILTERED subscriptionPayments ",
            this.subscription_payments
          );
        }
      },
      (error) => {
        this.logger.error(
          "[PRJCT-EDIT-ADD] - GET subscriptionPayments error ",
          error
        );
      ...
      () => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] - GET subscriptionPayments * COMPLETE * "
        );
        this.showSpinner = false;
      }
    );
  ...
  getCustomerAndPaymentMethods() {
    this.projectService.getStripeCustomer().subscribe(
      (customer: any) => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] - GET STRIPE CUSTOMER & PAYMENT METHODS - customer ",
          customer
        );
        if (customer) {
          this.customer_id = customer.id;
          this.logger.log(
            "[PRJCT-EDIT-ADD] - GET STRIPE CUSTOMER & PAYMENT METHODS - customer id",
            this.customer_id
          );
          if (
            ...
            this.customer_default_payment_method_id =
              customer.invoice_settings.default_payment_method;
            this.logger.log(
              "[PRJCT-EDIT-ADD] - GET STRIPE CUSTOMER & PAYMENT METHODS - customer_default_payment_method_id (from invoice_settings > default_payment_method)",
              this.customer_default_payment_method_id
            );
          } else {
            this.logger.log(
              "[PRJCT-EDIT-ADD] - GET STRIPE CUSTOMER & PAYMENT METHODS - customer_default_payment_method_id (from invoice_settings > default_payment_method) 2",
              this.customer_default_payment_method_id
            );
            this.logger.log(
              "[PRJCT-EDIT-ADD] - GET STRIPE CUSTOMER & PAYMENT METHODS - customer_default_payment_method_id (from customer > default_source) 2",
              customer.default_source
            );
            this.customer_default_payment_method_id = customer.default_source;
          }
          this.logger.log(
            "[PRJCT-EDIT-ADD] - GET STRIPE CUSTOMER & PAYMENT METHODS -  this.customer_default_payment_method_id",
            this.customer_default_payment_method_id
          );
          if (customer.paymentMethods) {
            customer.paymentMethods.data.forEach((paymentmethod) => {
              this.logger.log(
                "[PRJCT-EDIT-ADD] - GET STRIPE CUSTOMER & PAYMENT METHODS - customer >  paymentMethod ",
                paymentmethod
              );
              if (
                this.customer_default_payment_method_id !== null &&
                this.customer_default_payment_method_id === paymentmethod.id
              ) {
                this.logger.log(
                  "[PRJCT-EDIT-ADD] - GET STRIPE CUSTOMER & PAYMENT METHODS - customer > default paymentMethod ",
                  paymentmethod
                );
                if (paymentmethod.card) {
                  this.logger.log(
                    "[PRJCT-EDIT-ADD] - GET STRIPE CUSTOMER & PAYMENT METHODS - customer > default paymentMethod CARD",
                    paymentmethod.card
                  );
      ...
      (error) => {
        this.logger.error(
          "[PRJCT-EDIT-ADD] - GET STRIPE CUSTOMER error ",
          error
        );
      },
      () => {
  ...
  openModalAddPaymentMethod() {
    ...
    this.logger.log(
      "openModalAddPaymentMethod DISPLAY_ADD_CARD_COMPLETED ",
      this.DISPLAY_ADD_CARD_COMPLETED
    );
    this.CARD_HAS_ERROR = null;
    this.SPINNER_IN_ADD_CARD_MODAL = null;
    this.form.reset();
  ...
  creditCardNumberSpacing() {
    ...
    this.logger.log(
      "creditCardNumberSpacing creditCard value ",
      creditCard.value
    );
    if (creditCard.value) {
  ...
  updateCustomer(
    ...
    this.projectService
      ...
      .subscribe(
        (updatedcustomer: any) => {
          this.logger.log(
            "[PRJCT-EDIT-ADD] - UPDATED CUSTOMER - customer ",
            updatedcustomer
          );
        },
        (error) => {
          ...
          this.logger.error(
            "[PRJCT-EDIT-ADD] - UPDATED CUSTOMER error_body ",
            error_body
          );
          this.logger.error(
            "[PRJCT-EDIT-ADD] - UPDATED CUSTOMER error_body > msg ",
            error_body.msg
          );
          ...
          if (error_body && error_body.msg) {
            ...
            this.logger.error(
              "[PRJCT-EDIT-ADD] - UPDATED CUSTOMER error_body > msg > raw ",
              error_body.msg.raw
            );
            this.logger.error(
              "[PRJCT-EDIT-ADD] - UPDATED CUSTOMER credit_card_error_msg ",
              this.credit_card_error_msg
            );
            this.CARD_HAS_ERROR = true;
            this.SPINNER_IN_ADD_CARD_MODAL = false;
  ...
  getCustomerPaymentMethodsListAndDeleteNotDefault() {
    this.projectService
      .getCustomerPaymentMethodsList(this.customer_id)
      .subscribe(
        (paymentMethodsList: any) => {
          this.logger.log(
            "[PRJCT-EDIT-ADD] - GET PAYMENT METHODS LIST paymentMethodsList ",
            paymentMethodsList
          );
        },
        (error) => {
          this.logger.log(
            "[PRJCT-EDIT-ADD] - GET PAYMENT METHODS LIST * ERROR *",
            error
          );
        },
        () => {
          this.logger.log(
            "[PRJCT-EDIT-ADD] - GET PAYMENT METHODS LIST * COMPLETE *"
          );
        }
      );
  }
  ...
  listenCancelSubscription() {
    this.notify.cancelSubscriptionCompleted$.subscribe((hasDone: boolean) => {
      this.logger.log(
        "[PRJCT-EDIT-ADD] - (listenCancelSubscription) cancelSubscriptionCompleted hasDone",
        hasDone
      );
      if (hasDone === false) {
  ...
  getProjectId() {
    ...
    this.logger.log(
      "[PRJCT-EDIT-ADD] - PROJECT COMPONENT HAS PASSED id_project ",
      this.id_project
    );
    if (this.id_project) {
      this.getProjectById();
  ...
  goToContactDetails(requester_id) {
    this.router.navigate([
      "project/" + this.projectId + "/contact",
      requester_id,
    ]);
  }
  ...
  getAllLeads(projectObject) {
    ...
    this.contactsService
      .getAllLeadsActiveWithLimit(10000)
      .subscribe((leads: any) => {
        ...
        for (var i = 0; i < contacts.length; i++) {
          if (contacts[i] && contacts[i].fullname) {
            contacts[i]["leadInitials"] = avatarPlaceholder(
              contacts[i].fullname
            );
        ...
        this.logger.log(
          "[PRJCT-EDIT-ADD] PROJECT bannedVisitors ",
          bannedVisitors
        );
  ...
  unbanVisitor(bannedUserId: string) {
    this.logger.log(
      "[PRJCT-EDIT-ADD]  UNBAN VISITOR contact_id ",
      bannedUserId
    );
    this.projectService.unbanVisitor(bannedUserId).subscribe(
      (res: any) => {
      ...
      (error) => {
        ...
        this.notify.showWidgetStyleUpdateNotification(
          this.thereHasBeenAnErrorProcessing,
          4,
          "report_problem"
        );
      },
      () => {
        ...
        if (this.projectObject["bannedVisitors"]) {
          for (
            var i = 0;
            i < this.projectObject["bannedVisitors"].length;
            i++
          ) {
            if (
              this.projectObject["bannedVisitors"][i].bannedUsers_Id ===
              bannedUserId
            ) {
  ...
  getProjectById() {
    this.projectService.getProjectById(this.id_project).subscribe(
      (project: any) => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] - GET PROJECT BY ID - PROJECT OBJECT: ",
          project
        );
        if (project) {
          ...
          this.logger.log(
            "[PRJCT-EDIT-ADD] - PROJECT NAME TO UPDATE: ",
            this.projectName_toUpdate
          );

          if (project.ipFilter) {
            let IP_filterArrayToString = project.ipFilter.toString();
            // console.log('[PRJCT-EDIT-ADD] - IP FILTER ARRAY : ', IP_filterArrayToString);
            let IP_filterArrayToStringSpaced = IP_filterArrayToString.replace(
              /,/g,
              ", "
            );
          ...
          if (project.settings) {
            this.logger.log(
              "[PRJCT-EDIT-ADD] -  project.settings ",
              project.settings
            );
            this.logger.log(
              "[PRJCT-EDIT-ADD] -  project.settings displayWidget ",
              project.settings.displayWidget
            );
            this.logger.log(
              "[PRJCT-EDIT-ADD] -  project.settings .hasOwnProperty(displayWidget) ",
              project.settings.hasOwnProperty("displayWidget")
            );
            if (project.settings.hasOwnProperty("displayWidget")) {
              if (project.settings.displayWidget === true) {
                this.displaySupportWidget = true;
                this.logger.log(
                  "[PRJCT-EDIT-ADD] - ON INIT displaySupportWidget IS ",
                  project.settings.displayWidget
                );
              ...
              this.logger.log(
                "[PRJCT-EDIT-ADD] - ON INIT displaySupportWidget IS ",
                project.settings.displayWidget,
                "so set to true displaySupportWidget ",
                this.displaySupportWidget
              );
            }
            ...
            if (project.settings.email) {
              if (
                ...
                this.logger.log(
                  "[PRJCT-EDIT-ADD] - ON INIT AUTO SEND TRANSCRIPT IS ",
                  project.settings.email.autoSendTranscriptToRequester
                );

                this.AUTO_SEND_TRANSCRIPT_IS_ON = true;
                this.logger.log(
                  "[PRJCT-EDIT-ADD] - ON INIT AUTO SEND TRANSCRIPT IS ON ",
                  this.AUTO_SEND_TRANSCRIPT_IS_ON
                );
              } else {
              ...
              if (project.settings.email.notification) {
                if (project.settings.email.notification.conversation) {
                  if (
                    project.settings.email.notification.conversation
                      .assigned === true
                  ) {
                  ...
                  if (
                    project.settings.email.notification.conversation.pooled ===
                    true
                  ) {
          ...
          if (project.settings) {
            ...
            if (project.settings.max_agent_assigned_chat) {
              this.max_agent_assigned_chat =
                project.settings.max_agent_assigned_chat;
            } else {
            ...
            if (project.settings.automatic_unavailable_status_on) {
              this.automatic_unavailable_status_on =
                project.settings.automatic_unavailable_status_on;
            } else {
      ...
      (error) => {
        this.logger.error(
          "[PRJCT-EDIT-ADD] - GET PROJECT BY ID - ERROR ",
          error
        );
        this.showSpinner = false;
      },
  ...
  toggleChat_limit_on($event) {
    if ($event.target.checked) {
      ...
      this.logger.log(
        "[PRJCT-EDIT-ADD] - toggleChat_limit_on ",
        this.chat_limit_on
      );
    } else {
      this.chat_limit_on = false;
  ...
  toggleReassignment_on($event) {
    if ($event.target.checked) {
      ...
      this.logger.log(
        "[PRJCT-EDIT-ADD] - toggleReassignment_on ",
        this.reassignment_on
      );
    } else {
      this.reassignment_on = false;
      this.logger.log(
  ...
  toggleUnavailable_status_on($event) {
    if ($event.target.checked) {
      ...
      this.logger.log(
        "[PRJCT-EDIT-ADD]- toggleUnavailable_status_on ",
        this.automatic_unavailable_status_on
      );
    } else {
      this.automatic_unavailable_status_on = false;
  ...
  toggleSupportWidgetVisibility($event) {
    ...
    this.projectService
      .enableDisableSupportWidgetVisibility(this.displaySupportWidget)
      .then((result) => {
  ...
  toggleProjectAssignedConversation($event) {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - Event Toggle Assigned: ",
      $event.target.checked
    );
    this.assigned_conv_on = $event.target.checked;

    this.projectService
      .enableDisableAssignedNotification(this.assigned_conv_on)
      .then((result) => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] - ENABLE/DISABLED ASSIGNED NOTIFICATION RESULT: ",
          result
        );
        this.notify.showWidgetStyleUpdateNotification(
          this.updateSuccessMsg,
      ...
      .catch((err) => {
        this.logger.error(
          "[PRJCT-EDIT-ADD] - Error during ENABLE/DISABLED ASSIGNED NOTIFICATION updating: ",
          err
        );
        this.notify.showWidgetStyleUpdateNotification(
          this.updateErrorMsg,
  ...
  toggleProjectUnassignedConversation($event) {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - Event Toggle UNASSIGNED: ",
      $event.target.checked
    );
    this.unassigned_conv_on = $event.target.checked;

    this.projectService
      .enableDisableUnassignedNotification(this.unassigned_conv_on)
      .then((result) => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] ENABLE/DISABLED UNASSIGNED NOTIFICATION RESULT: ",
          result
        );
        this.notify.showWidgetStyleUpdateNotification(
          this.updateSuccessMsg,
      ...
      .catch((err) => {
        this.logger.error(
          "PRJCT-EDIT-ADD] Error during  ENABLE/DISABLED UNASSIGNED NOTIFICATION updating: ",
          err
        );
        this.notify.showWidgetStyleUpdateNotification(
          this.updateErrorMsg,
  ...
  saveIPranges() {
    this.logger.log(
      "[PRJCT-EDIT-ADD] SAVE IP RANGES - id_project",
      this.id_project
    );
    this.logger.log(
      "[PRJCT-EDIT-ADD] SAVE IP RANGES - allowedIPranges",
      this.allowedIPs
    );

    this.logger.log(
      "[PRJCT-EDIT-ADD] SAVE IP RANGES - ip_restrictions_on",
      this.ip_restrictions_on
    );
    let allowedIPsArray = [];
    if (this.allowedIPs) {
      const allowedIPsTrimmed = this.allowedIPs.replace(/\s/g, "");
      this.logger.log(
        "[PRJCT-EDIT-ADD] SAVE IP RANGES - allowedIPranges allowedIPsTrimmed ",
        allowedIPsTrimmed
      );
      allowedIPsArray = allowedIPsTrimmed.split(",");
      this.logger.log(
        "[PRJCT-EDIT-ADD] SAVE IP RANGES - allowedIPranges split ",
        allowedIPsArray
      );
    ...
    if (this.ip_restrictions_on && allowedIPsArray.length > 0) {
      swal({
        ...
        if (willAddIpRanges) {
          this.logger.log(
            "[PRJCT-EDIT-ADD] swal willAddIpRanges",
            willAddIpRanges
          );
          // this.id_project,
          ...
          this.projectService
            ...
            .subscribe(
              (res: any) => {
                this.logger.log(
                  "[PRJCT-EDIT-ADD] addAllowedIPranges res ",
                  res
                );
              },
              (error) => {
                this.logger.error(
                  "[PRJCT-EDIT-ADD] addAllowedIPranges - ERROR ",
                  error
                );
              ...
              () => {
                this.logger.log(
                  "[PRJCT-EDIT-ADD] addAllowedIPranges * COMPLETE *"
                );
  ...
  onProjectNameChange(event) {
    ...
    this.logger.log(
      "[PRJCT-EDIT-ADD] - ON PROJECT NAME TO UPDATE ",
      this.project_name
    );
  ...
  edit() {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - PROJECT ID WHEN EDIT IS PRESSED ",
      this.id_project
    );
    this.logger.log(
      "[PRJCT-EDIT-ADD] - PROJECT NAME WHEN EDIT IS PRESSED ",
      this.projectName_toUpdate
    );

    this.projectService
      .updateProjectName(this.id_project, this.projectName_toUpdate)
      .subscribe(
        (prjct: Project) => {
          ...
          if (prjct) {
            ...
            this.auth.projectSelected(
              prjct,
              "project-edit-add update-project-name"
            );
  ...
  autoSendTranscriptOnOff($event) {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - AUTO SEND TRANSCRIPT BY EMAIL ON ",
      $event.target.checked
    );

    this.projectService
      .updateAutoSendTranscriptToRequester($event.target.checked)
      .subscribe(
        (prjct) => {
          this.logger.log(
            "[PRJCT-EDIT-ADD] AUTO SEND TRANSCRIPT UPDATE PROJECT - RES ",
            prjct
          );
        },
        (error) => {
          this.logger.error(
            "[PRJCT-EDIT-ADD] AUTO SEND TRANSCRIPT UPDATE PROJECT - ERROR ",
            error
          );
          this.notify.showWidgetStyleUpdateNotification(
            this.updateErrorMsg,
        ...
        () => {
          this.logger.log(
            "[PRJCT-EDIT-ADD] AUTO SEND TRANSCRIPT UPDATE PROJECT * COMPLETE *"
          );
          this.notify.showWidgetStyleUpdateNotification(
            this.updateSuccessMsg,
            2,
  ...
  updateAdvancedSettings() {
    ...
    const updateAdvancedSettingBtn = <HTMLElement>(
      document.querySelector(".btn_edit_advanced_settings")
    );
    this.logger.log(
      "[PRJCT-EDIT-ADD]  - UPDATE ADVANCED SETTINGS BTN ",
      updateAdvancedSettingBtn
    );
    updateAdvancedSettingBtn.blur();
    this.logger.log(
      "[PRJCT-EDIT-ADD] - UPDATE ADVANCED SETTINGS - max_agent_assigned_chat ",
      this.max_agent_assigned_chat,
      " reassignment_delay ",
      this.reassignment_delay,
      " automatic_idle_chats ",
      this.automatic_idle_chats
    );

    this.logger.log(
      "[PRJCT-EDIT-ADD] - UPDATE ADVANCED SETTINGS - chat_limit_on ",
      this.chat_limit_on,
      " reassignment_on ",
      this.reassignment_on,
    ...
    this.projectService
      ...
      .subscribe(
        (prjct: Project) => {
          ...
          this.auth.projectSelected(
            prjct,
            "project-edit-add update-advanced-settings"
          );
          localStorage.setItem(prjct._id, JSON.stringify(prjct));
        },
        (error) => {
          this.logger.error(
            "[PRJCT-EDIT-ADD] - UPDATE ADVANCED SETTINGS - ERROR ",
            error
          );
          this.notify.showWidgetStyleUpdateNotification(
            this.updateErrorMsg,
        ...
        () => {
          this.logger.log(
            "[PRJCT-EDIT-ADD] - UPDATE ADVANCED SETTINGS * COMPLETE *"
          );
          this.notify.showWidgetStyleUpdateNotification(
            this.updateSuccessMsg,
            2,
  ...
  onChangeMaximum_chats($event) {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - UPDATE ADVANCED SETTINGS - ON CHANGE MAXIMUM CHAT  ",
      $event
    );
    ...
    if ($event < 1) {
      ...
      this.logger.log(
        "[PRJCT-EDIT-ADD] - UPDATE ADVANCED SETTINGS - ON CHANGE MAXIMUM CHAT - HAS MIN ERROR ",
        this.maximum_chats_has_minimum_error
      );
    } else {
    ...
    if ($event > 10000000) {
      ...
      this.logger.log(
        "[PRJCT-EDIT-ADD] - UPDATE ADVANCED SETTINGS - ON CHANGE MAXIMUM CHAT - HAS MAX ERROR ",
        this.maximum_chats_has_maximum_error
      );
    } else {
  ...
  onChangeReassignment_timeout($event) {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - UPDATE ADVANCED SETTINGS - ON CHANGE REASSIGMENT TIMEOUT ",
      $event
    );
    ...
    if ($event < 1) {
      ...
      this.logger.log(
        "[PRJCT-EDIT-ADD] - UPDATE ADVANCED SETTINGS - ON CHANGE REASSIGMENT TIMEOUT - HAS MIN ERROR ",
        this.reassignment_timeout_has_minimum_error
      );
    } else {
    ...
    if ($event > 10000000) {
      ...
      this.logger.log(
        "[PRJCT-EDIT-ADD] - UPDATE ADVANCED SETTINGS - ON CHANGE REASSIGMENT TIMEOUT - HAS MAX ERROR ",
        this.reassignment_timeout_has_maximum__error
      );
    } else {
  ...
  onChangeAutomaticUnavailable($event) {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - UPDATE ADVANCED SETTINGS - ON CHANGE Automatic Unavailable after a n of chat ",
      $event
    );
    ...
    if ($event < 1) {
      ...
      this.logger.log(
        "[PRJCT-EDIT-ADD] - ADVANCED SETTINGS - ON CHANGE REASSIGMENT TIMEOUT - HAS MIN ERROR ",
        this.reassignment_timeout_has_minimum_error
      );
    } else {
  ...
  generateSharedSecret() {
    this.displayConfirmJwtSecretCreationModal = "none";
    this.projectService.generateSharedSecret().subscribe(
      (res) => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] - GENERATE SHARED SECRET - RESPONSE ",
          res
        );
      ...
      (error) => {
        this.logger.error(
          "[PRJCT-EDIT-ADD] GENERATE SHARED SECRET - ERROR ",
          error
        );
      },
      () => {
        this.logger.log(
          "[PRJCT-EDIT-ADD] GENERATE SHARED SECRET  * COMPLETE *"
        );
  ...
  openDeleteModal() {
    this.logger.log(
      "[PRJCT-EDIT-ADD] - OPEN DELETE MODAL -> PROJECT ID ",
      this.id_project
    );
    if (this.USER_ROLE === "owner") {
      this.display = "block";
      ...
      this.notify.presentModalOnlyOwnerCanManageTheAccountPlan(
        this.onlyATeammateWithTheOwnerRoleCanDeleteAProject_lbl,
        this.learnMoreAboutDefaultRoles
      );
    }
  ...
  deleteProject() {
    ...
    this.logger.log(
      "[PRJCT-EDIT-ADD] - deleteProject ID PROJECT TO DELETE ",
      this.project_id_to_delete
    );
    this.logger.log(
      "[PRJCT-EDIT-ADD] - deleteProject ID PROJECT ",
      this.id_project
    );
    ...
    this.projectService.deleteProject(this.id_project).subscribe(
      ...
      () => {
        ...
        setTimeout(() => {
          this.SHOW_CIRCULAR_SPINNER = false;
          this.notify.showNotificationChangeProject(
  ...
  goToWebhookPage() {
    this.logger.log(
      "[PRJCT-EDIT-ADD] GO TO WEBHOOK PAGE > ProjectID: ",
      this.id_project
    );
    ...
    if (
      this.prjct_profile_type === "free" &&
      this.prjct_trial_expired === false
    ) {
        ...
        if (this.isVisiblePaymentTab) {
          if (this.USER_ROLE === "owner") {
            if (
              ...
              this.logger.log(
                "[PRJCT-EDIT-ADD] profile_name ",
                this.profile_name
              );
            } else if (
              (this.profile_name === "free" &&
                this.prjct_trial_expired === true) ||
              (this.profile_name === "Sandbox" &&
                this.prjct_trial_expired === true)
            ) {
              //
  ...
  getTestSiteUrl() {
    this.TESTSITE_BASE_URL =
      this.appConfigService.getConfig().WIDGET_BASE_URL +
      "assets/twp/index.html";
    this.logger.log(
      "[PRJCT-EDIT-ADD] getAppConfig TESTSITE_BASE_URL",
      this.TESTSITE_BASE_URL
    );

    this.TEST_WIDGET_API_BASE_URL = this.TESTSITE_BASE_URL.replace(
      "index.html",
      "index-dev.html"
    );
    this.logger.log(
      "[PRJCT-EDIT-ADD] getAppConfig TEST_WIDGET_API_BASE_URL",
      this.TEST_WIDGET_API_BASE_URL
    );
  }

  goToWidgetTestPage() {
    const widgetTestPageBtnElem = <HTMLElement>(
      document.querySelector(".test-widget-api-btn")
    );
