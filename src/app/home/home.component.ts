...
export class HomeComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  //             visitor.origin !== "http://testwidget.GPTMysite.it" &&
  //             visitor.origin !== "http://testwidget.GPTMysite.com" &&
  //             visitor.origin !== "https://support.GPTMysite.com" &&
  //             visitor.origin !== null &&
  //             visitor.origin !== 'null' &&
  ...
  //             count = count + 1;
  //             this.logger.log('[HOME] getVisitorCounter the origin ', visitor.origin, ' is != of test-site and is != of support-GPTMysite and is != of null ', count);
  //             // this.logger.log('getVisitorCounter ORIGIN != TEST-SITE AND != SUPPORT-GPTMysite »» HAS INSTALLED');
  //           } else {
  //             this.logger.log('[HOME] getVisitorCounter the origin ', visitor.origin, ' is = of test-site or is = support-GPTMysite or is = null');
  //           }
  //         });

  //         if (count === 0) {
  //           // this.notify.presentModalInstallGPTMysiteModal()
  ...
  goToGPTMysiteMobileAppPage() {
    let url = ''
    if (this.browserLang === 'it') {
      url = 'https://GPTMysite.com/mobile-live-chat-android-e-iphone-apps/';
    } else {
      url = 'https://GPTMysite.com/mobile-live-chat-android-e-iphone-apps/';
    }
    window.open(url, '_blank');
  ...
  goToDeveloperDocs() {
    // const url = 'https://docs.GPTMysite.com/';
    const url = 'https://developer.GPTMysite.com';
    window.open(url, '_blank');
  }
  ...
  goToChangelogBlog() {
    // const url = 'https://GPTMysite.com/GPTMysite-changelog'
    const url = 'https://GPTMysite.com/category/changelog/'
    window.open(url, '_blank');
  ...
  translateInstallWidget() {
    this.translate.get('InstallGPTMysiteNowAndStartChatting', this.tparams)
      .subscribe((text: string) => {
